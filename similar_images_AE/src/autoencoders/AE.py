...
class AE(AEBase):
    ...
    def train(self, x_train, x_test, n_epochs=50, batch_size=256):
        self.autoencoder.fit(x_train, x_train,
                             ...
                             callbacks=[TensorBoard(log_dir='/media/sarthak/HDD/TUM/courses/sem_3/DLCV/project/logs/auto_1')])
    ...
    def set_arch(self, input_shape=None, output_shape=None):
        ...
        if self.model_name == "simpleAE":
            ...
            n_hidden_2 = 128  # 2nd hidden layer
            n_hidden_3 = 256  # 3rd hidden layer
            n_hidden_4 = 512
            ...
            ### Decoding hidden layers ###
            x = Conv2D(n_hidden_4, convkernel, activation='relu', padding='same')(encoded)
            x = Conv2D(n_hidden_4, convkernel, activation='relu', padding='same')(x)
            x = Conv2D(n_hidden_4, convkernel, activation='relu', padding='same')(x)
            ...
            x = Conv2D(n_hidden_2, convkernel, activation='relu', padding='same')(x)
            x = UpSampling2D(poolkernel)(x)
            x = Conv2D(n_hidden_1, convkernel, activation='relu', padding='valid')(x)
            x = Conv2D(n_hidden_1, convkernel, activation='relu', padding='valid')(x)
            x = UpSampling2D(poolkernel)(x)
            decoded = Conv2D(output_shape[2], convkernel, activation='sigmoid')(x)  # output layer
            """
            n_hidden_1 = 32  # 1st hidden layer
            n_hidden_2 = 64  # 2nd hidden layer
            n_hidden_3 = 128  # 3rd hidden layer
            ...
            x = Conv2D(n_hidden_1, convkernel, activation='relu', padding='same')(x)
            x = UpSampling2D(poolkernel)(x)
            decoded = Conv2D(output_shape[2], convkernel, activation='sigmoid', padding='valid')(x)  # output layer
        else:
        ...
        if self.model_name == 'simpleAE':
            ...
            """
            decoded_output = autoencoder.layers[-19](decoded_input)  # Conv2D
            decoded_output = autoencoder.layers[-18](decoded_output)  # UpSampling2D
            decoded_output = autoencoder.layers[-17](decoded_output)  # Conv2D
            decoded_output = autoencoder.layers[-16](decoded_output)  # UpSampling2D
            decoded_output = autoencoder.layers[-15](decoded_output)  # Conv2D
            decoded_output = autoencoder.layers[-14](decoded_output)  # UpSampling2D
            decoded_output = autoencoder.layers[-13](decoded_output)  # Conv2D
            decoded_output = autoencoder.layers[-12](decoded_output)  # Conv2D
            decoded_output = autoencoder.layers[-11](decoded_output)  # UpSampling2D
            decoded_output = autoencoder.layers[-10](decoded_output)  # Conv2D
            decoded_output = autoencoder.layers[-9](decoded_output)  # UpSampling2D
            decoded_output = autoencoder.layers[-8](decoded_output)  # Conv2D
            decoded_output = autoencoder.layers[-7](decoded_output)  # UpSampling2D
            decoded_output = autoencoder.layers[-6](decoded_output)  # Conv2D
